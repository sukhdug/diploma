...
/**
 * NotificationBooksFixture
 *
 */
class NotificationBooksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'reader_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'notification_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'user_choose' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'reader_id' => 1,
            'notification_id' => 1,
            'user_choose' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
